...
const FIELD_LABELS={
  ...
  amount:'المبلغ',method:'طريقة الدفع',reference:'المرجع',transaction_type:'نوع الحركة',refund_amount:'قيمة الاسترداد',reason:'السبب',driver_id:'السائق',vehicle_id:'المركبة',license_no:'رقم الرخصة',license_expiry:'انتهاء الرخصة',plate_no:'رقم اللوحة',physical_capacity:'السعة الفعلية',booking_capacity:'سعة الحجز',departure_date:'تاريخ الرحلة',departure_time:'وقت الرحلة',from_city:'مدينة المغادرة',to_city:'الوجهة',employee_code:'رقم الموظف',national_id:'الهوية / الإقامة',department:'القسم',job_title:'المسمى الوظيفي',staff_user_id:'حساب الموظف',shift_start:'بداية الدوام',shift_end:'نهاية الدوام',grace_minutes:'دقائق السماح',weekly_off_days:'الإجازة الأسبوعية',shift_periods:'فترات الدوام',schedule_changed:'تم تغيير جدول الدوام',schedule_effective_from:'سريان جدول الدوام من',schedule_version:'نسخة الدوام المحفوظة',active_schedule_version_id:'نسخة الدوام الفعالة الآن',scheduled_for_future:'جدول مجدول للمستقبل',activates_on:'يتفعّل بتاريخ',atomic_schedule_save:'حفظ ذري للجدول',auto_push:'رفع تلقائي للأجهزة',devices_queued:'أجهزة تم تجهيز الرفع لها',merged_into_id:'مدموج داخل السجل',merged_at:'وقت الدمج',merge_reason:'سبب الدمج',agent_code:'كود الوكيل',company_name:'الجهة / الشركة',commercial_registration:'السجل التجاري',tax_number:'الرقم الضريبي',credit_limit:'حد الائتمان',current_balance:'الرصيد الحالي',default_commission_type:'نوع العمولة',default_commission_value:'قيمة العمولة',default_discount_type:'نوع الخصم',default_discount_value:'قيمة الخصم',allow_credit:'السماح بالآجل',allow_group_booking:'السماح بحجز المجموعات',portal_enabled:'بوابة الوكيل',credit_control_mode:'وضع التحكم الائتماني',credit_warning_percent:'نسبة تحذير الائتمان',credit_terms_days:'مدة السداد بالأيام',agent_credit_warning:'تحذير ائتماني',agent_credit_snapshot:'لقطة الائتمان',collector_user_id:'موظف التحصيل',manual_priority:'أولوية التحصيل',next_followup_date:'موعد المتابعة القادمة',reference_no:'رقم المرجع',entry_type:'نوع حركة الوكيل',direction:'الطرف',balance_after:'الرصيد بعد الحركة',source_type:'مصدر الحركة',source_id:'معرف المصدر',opening_balance:'الرصيد الافتتاحي',currency:'العملة'
};

const ACTION_LABELS={
  booking_created:'تم إنشاء الحجز',booking_updated:'تم تعديل الحجز',booking_cancelled:'تم إلغاء الحجز',booking_deleted:'تم حذف الحجز',passenger_created:'تمت إضافة مسافر',passenger_updated:'تم تعديل بيانات مسافر',passenger_deleted:'تم حذف مسافر',transaction_created:'تم تسجيل تحصيل',payment_created:'تم تسجيل دفعة',refund_created:'تم تنفيذ استرداد',room_assignment_created:'تم تسكين مسافر',room_assignment_updated:'تم تعديل التسكين',room_assignment_deleted:'تم إلغاء التسكين',seat_assignment_created:'تم تعيين مقعد',seat_assignment_updated:'تم تعديل المقعد',seat_assignment_deleted:'تم تحرير المقعد',trip_created:'تم إنشاء رحلة',trip_updated:'تم تعديل رحلة',trip_cancelled:'تم إلغاء رحلة',driver_created:'تمت إضافة سائق',driver_updated:'تم تعديل سائق',driver_deleted:'تم حذف سائق',vehicle_created:'تمت إضافة مركبة',vehicle_updated:'تم تعديل مركبة',vehicle_deleted:'تم حذف مركبة',permission_updated:'تم تعديل الصلاحيات',staff_updated:'تم تعديل موظف',staff_created:'تمت إضافة موظف',destination_created:'تمت إضافة وجهة',destination_updated:'تم تعديل وجهة',destination_deleted:'تم حذف وجهة',route_created:'تمت إضافة مسار',route_updated:'تم تعديل مسار',route_deleted:'تم حذف مسار',passenger_merged:'تم دمج سجل مسافر مكرر',attendance_employee_merged:'تم دمج سجل موظف حضور مكرر',attendance_employee_create:'تم إنشاء موظف حضور',attendance_employee_update:'تم تعديل موظف حضور',attendance_schedule_activated:'تم تفعيل جدول دوام مجدول',company_form_create:'تم إنشاء نموذج شركة',company_form_update:'تم تعديل نموذج شركة',company_form_submit:'تم إرسال نموذج للاعتماد',company_form_step_approved:'تم اعتماد خطوة من النموذج',company_form_approve:'تم اعتماد النموذج نهائيًا',company_form_reject:'تم رفض النموذج',company_form_cancel:'تم إلغاء النموذج',company_form_auto_approved:'تم اعتماد النموذج تلقائيًا',company_form_attachment_upload:'تم رفع مرفق للنموذج',company_form_attachment_delete:'تم حذف مرفق من النموذج',company_form_template_create:'تم إنشاء قالب نموذج مخصص',company_form_template_update:'تم تحديث قالب نموذج مخصص',attendance_calendar_rule_create:'تمت إضافة استثناء للدوام',attendance_calendar_rule_update:'تم تعديل استثناء الدوام',attendance_calendar_rule_delete:'تم حذف استثناء الدوام',agent_merged:'تم دمج سجل وكيل مكرر',agent_ledger_initialized:'تم تهيئة كشف حساب الوكيل',agent_ledger_entry_posted:'تم ترحيل حركة على حساب الوكيل',agent_credit_policy_updated:'تم تعديل سياسة ائتمان الوكيل',agent_collection_promise_created:'تم إنشاء وعد سداد للوكيل',agent_collection_promise_followup:'تم تسجيل متابعة تحصيل',agent_collection_promise_kept:'تم الوفاء بوعد السداد',agent_collection_promise_broken:'لم يتم الوفاء بوعد السداد',agent_collection_promise_cancelled:'تم إلغاء وعد السداد',agent_collection_assignment_updated:'تم تحديث مسؤول وأولوية التحصيل',refund_requested:'تم طلب استرداد',refund_approved_direct:'تم اعتماد استرداد',refund_completed_direct:'تم تنفيذ استرداد'};

const ENTITY_LABELS={bookings:'الحجز',booking:'الحجز',booking_passengers:'المسافر',passenger:'المسافر',trips:'الرحلة',trip:'الرحلة',transactions:'التحصيل',refunds:'الاسترداد',room_assignments:'التسكين',seat_assignments:'المقاعد',drivers:'السائق',vehicles:'المركبة',staff_users:'حساب الموظف',agents:'الوكيل',customer_profiles:'حساب العميل',travel_destinations:'الوجهة',destination_routes:'المسار',attendance_employee:'موظف الحضور',attendance_employees:'موظف الحضور',attendance_calendar_rule:'استثناء / قاعدة دوام',attendance_employee_schedule_version:'نسخة دوام الموظف',company_form_submission:'مستند / نموذج شركة',company_form_template:'قالب نموذج شركة'};
...
function auditPeriodsSummary(value){if(!Array.isArray(value))return '';return value.length?value.map((p,i)=>(p?.label||('الفترة '+String(i+1)))+' '+String(p?.start_time||'').slice(0,5)+'–'+String(p?.end_time||'').slice(0,5)).join(' | '):'لا توجد فترات دوام'}
function auditOffDaysSummary(value){if(!Array.isArray(value))return '';return value.length?value.map(Number).sort().map(n=>WEEKDAYS[n]||String(n)).join('، '):'لا توجد راحة أسبوعية'}

export const auditFieldLabel=field=>{const raw=String(field||'بيان'),leaf=raw.split('.').pop(),prefix=raw.startsWith('canonical.')?'السجل الأساسي — ':raw.startsWith('duplicate.')?'السجل المكرر — ':'';return prefix+(FIELD_LABELS[leaf]||leaf.replace(/_/g,' '))};
...
export function auditValue(field,value,context={}){
  ...
  if(f==='shift_periods'&&Array.isArray(value))return auditPeriodsSummary(value);
  if(f==='weekly_off_days'&&Array.isArray(value))return auditOffDaysSummary(value);
  if(f==='schedule_version'&&value&&typeof value==='object'){const from=value.effective_from||value.schedule_effective_from||'',to=value.effective_to||'';return from?('سارية من '+from+(to?' إلى '+to:' حتى إشعار آخر')):'نسخة دوام محفوظة'}
