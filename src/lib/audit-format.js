...
const ENTITY_LABELS={bookings:'الحجز',booking:'الحجز',booking_passengers:'المسافر',passenger:'المسافر',trips:'الرحلة',trip:'الرحلة',transactions:'التحصيل',refunds:'الاسترداد',room_assignments:'التسكين',seat_assignments:'المقاعد',drivers:'السائق',vehicles:'المركبة',staff_users:'الموظف',travel_destinations:'الوجهة',destination_routes:'المسار',attendance_employee:'موظف الحضور',attendance_employees:'موظف الحضور'};
