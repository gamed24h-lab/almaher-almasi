...
export const statusLabel=v=>({
 new:'جديد',confirmed:'مؤكد',paid:'مدفوع',cancelled:'ملغي',used:'مستخدم',completed:'مكتمل',active:'نشط',inactive:'موقوف',pending:'قيد المراجعة',approved:'معتمد',rejected:'مرفوض',
 available:'متاح',open:'مفتوح',closed:'مغلق',posted:'مرحّل',draft:'مسودة',in_progress:'قيد التنفيذ',done:'منتهٍ',resolved:'تم الحل',waiting:'بانتظار العميل',contacted:'تم التواصل',qualified:'مؤهل',follow_up:'متابعة',won:'تم التحويل',lost:'مغلق',urgent:'عاجل',high:'عالي',normal:'عادي',low:'منخفض'
