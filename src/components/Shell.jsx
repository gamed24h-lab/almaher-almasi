...
import {LayoutDashboard,BusFront,MapPinned,ClipboardList,Users,Hotel,Armchair,Truck,WalletCards,Receipt,ScanLine,HeartHandshake,FileText,BellRing,RotateCcw,ShieldCheck,BarChart3,Code2,LogOut,PanelRightClose,PanelRightOpen,Search,Globe2,Building2,Handshake,CheckSquare2,ChevronDown,Palette,Fingerprint,Menu,X,BriefcaseBusiness,Settings2,UserRoundCog,Layers3} from 'lucide-react';
...
const items=[
 ...
 {p:'/workflow',key:'workflow',Icon:CheckSquare2,perms:['operations','approvals','tasks'],group:'management'},
...
export default function Shell({children,route,go}){
 ...
 const labelFor=x=>x.key==='destinations'?'إدارة الوجهات':x.key==='wallets'?'محافظ العملاء':x.key==='attendance'?'الحضور والبصمة':x.key==='idStudio'?'بطاقات ID':t(x.key);
