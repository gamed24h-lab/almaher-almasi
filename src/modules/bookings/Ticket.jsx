...
export default function TicketPage({bookingNo,go}){
 ...
 const roomByPassenger=useMemo(()=>{
  const currentPassengerIds=new Set(passengers.map(p=>str(p.id)));
 ...
 const hasActualHousing=housingEntries.length>0;
 ...
 const paymentMethod=paymentMethodLabel(b.payment_method,printLanguage);
