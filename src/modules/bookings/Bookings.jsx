...
import {Plus,Search,RefreshCw,FilterX,Ticket,RotateCcw,MessageCircle,Pencil,UsersRound,ArrowUpDown} from 'lucide-react';
...
export default function Bookings({go,query=''}){
 ...
 const canEdit=has(user,'editBookings');const canRefund=has(user,'refunds')||has(user,'refund_request');const canPrint=has(user,'printTickets');
