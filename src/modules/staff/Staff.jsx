...
const HIGH_RISK=new Set(['managePermissions','manageUsers','allBranches','allBranchesFinance','crossBranchReturn','bookingDiscount','addBranches','manageCompanyProfile','refund_approve','refund_complete','approvals','deleteDestinations','manageDestinations','deleteDrivers','deleteVehicles','manageDrivers','deleteHotels','manageHotels']);
