...
const GENERAL_PERMS=[
 ...
 ['trips','إدارة الرحلات'],['viewDestinations','عرض إدارة الوجهات'],['addDestinations','إضافة وجهات'],['editDestinations','تعديل/تفعيل الوجهات'],['deleteDestinations','حذف الوجهات والمسارات'],['manageDestinationRoutes','إدارة المسارات الجاهزة'],['manageDestinations','إدارة الوجهات كاملة'],['operations','التشغيل'],['manifest','كشف التشغيل'],['housingManifest','كشف التسكين'],['scanner','QR والمسح'],['housing','التسكين'],['seats','المقاعد'],['fleet','الأسطول'],['vehicles','المركبات'],['returns','محرك العودة'],
...
const HIGH_RISK=new Set(['managePermissions','manageUsers','allBranches','allBranchesFinance','addBranches','manageCompanyProfile','refund_approve','refund_complete','approvals','deleteDestinations','manageDestinations']);
...
const ROLE_TEMPLATES={
 ...
 'مشرف تشغيل':['viewBookings','trips','viewDestinations','addDestinations','editDestinations','manageDestinationRoutes','operations','manifest','housingManifest','scanner','housing','seats','fleet','vehicles','returns','notifications'],
