...
const GENERAL_PERMS=[
 ...
 ['operations','التشغيل'],['manifest','كشف التشغيل'],['housingManifest','كشف التسكين'],['scanner','QR والمسح'],['housing','التسكين'],['seats','المقاعد'],
...
const HIGH_RISK=new Set(['managePermissions','manageUsers','allBranches','allBranchesFinance','addBranches','manageCompanyProfile','refund_approve','refund_complete','approvals','deleteDestinations','manageDestinations','deleteDrivers','deleteVehicles','manageDrivers']);
...
const ROLE_TEMPLATES={
 ...
 'مشرف تشغيل':['viewBookings','trips','viewDestinations','addDestinations','editDestinations','manageDestinationRoutes','operations','manifest','housingManifest','scanner','housing','seats','fleet','viewFleet','vehicles','addVehicles','editVehicles','viewDrivers','addDrivers','editDrivers','assignFleet','manageMaintenance','returns','notifications'],
