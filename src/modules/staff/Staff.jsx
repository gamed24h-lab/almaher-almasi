...
const GENERAL_PERMS=[
 ['branchBooking','إنشاء حجوزات'],['viewBookings','عرض الحجوزات'],['editBookings','تعديل الحجوزات'],['cancelBookings','إلغاء الحجوزات'],['editPassenger','تعديل الركاب'],['changeTrip','نقل الحجز بين الرحلات'],['crossBranchReturn','اختيار عودة من فرع آخر'],['bookingDiscount','منح خصم على الحجز'],['reactivateBooking','إعادة تفعيل حجز ملغي'],['printTickets','طباعة التذاكر'],
...
const ROLE_TEMPLATES={
 ...
 'محاسب':['viewBookings','finance','viewPaymentReceipts','printPaymentReceipts','reconcileFinance','expenses','shifts','refunds','refund_request','reports','printReports'],
 ...
 'مدير فرع':['branchBooking','viewBookings','editBookings','cancelBookings','editPassenger','changeTrip','printTickets','trips','viewDestinations','addDestinations','editDestinations','manageDestinationRoutes','operations','manifest','housingManifest','scanner','housing','viewHotels','addHotels','editHotels','linkHotels','manageHotelRooms','seats','fleet','viewFleet','vehicles','addVehicles','editVehicles','viewDrivers','addDrivers','editDrivers','assignFleet','manageMaintenance','returns','finance','viewPaymentReceipts','printPaymentReceipts','reconcileFinance','expenses','shifts','refunds','refund_request','approvals','crm','customers','documents','notifications','reports','printReports','manageUsers','viewBranches','editBranches'],
