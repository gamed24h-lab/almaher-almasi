...
const ROLE_TEMPLATES={
 ...
 'مدير فرع':['branchBooking','viewBookings','editBookings','editPassenger','changeTrip','printTickets','trips','viewDestinations','addDestinations','editDestinations','manageDestinationRoutes','operations','manifest','housingManifest','scanner','housing','viewHotels','addHotels','editHotels','linkHotels','manageHotelRooms','seats','fleet','viewFleet','vehicles','addVehicles','editVehicles','viewDrivers','addDrivers','editDrivers','assignFleet','manageMaintenance','returns','finance','payments','expenses','shifts','refunds','refund_request','approvals','crm','customers','documents','notifications','reports','printReports','manageUsers','viewBranches','editBranches'],
