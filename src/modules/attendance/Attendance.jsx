...
export default function Attendance(){
 const [state,setState]=useState({devices:[],deviceUsers:[],commands:[],deviceShiftTemplates:[],deleteRequests:[],links:[],logs:[],employees:[],shiftPeriods:[],users:[],branches:[],permissions:{},adms:{}}),[loading,setLoading]=useState(true),[error,setError]=useState(''),[notice,setNotice]=useState('');
