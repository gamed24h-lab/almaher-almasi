...
import {Clock3,Database,DownloadCloud,Fingerprint,History,Plus,RefreshCw,Trash2,UploadCloud,UserPlus,Users} from 'lucide-react';
...
export default function AttendanceDeviceData({state,onChanged,onError,onNotice}){
 ...
 const devices=state.devices||[],deviceUsers=state.deviceUsers||[],commands=state.commands||[],links=state.links||[],deviceShiftTemplates=state.deviceShiftTemplates||[];
