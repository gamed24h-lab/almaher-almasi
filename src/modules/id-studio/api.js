...
export const idStudioApi={
  ...
  listTemplateVersions:(code)=>call('id_studio_template_versions_list',{code}),
  saveTemplate:(code,config,defaultOrientation,reason='')=>call('id_studio_template_save',{code,config,default_orientation:defaultOrientation,reason}),
  restoreTemplate:(code,version)=>call('id_studio_template_restore',{code,...(version?{version}:{})}),
