...
function deviceHealthSnapshot(device,latestLog,deviceCommands=[],unlinkedCount=0,unlinkedTruncated=false){
 ...
 if(clockVerificationPending){if(connection!=='offline'){label='بانتظار تحقق الساعة';tone='blue'}issues.push('تم إرسال تحديث الساعة للجهاز واستلمه بنجاح؛ بانتظار أول بصمة Live للتحقق من الوقت الفعلي.')}
