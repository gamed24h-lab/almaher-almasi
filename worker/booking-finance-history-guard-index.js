...
function requestWithPaid(request,body,paid){const next={...body,booking:{...(body?.booking||{}),paidAmount:paid,paid_amount:paid}};const h=new Headers(request.headers);h.delete('content-length');return new Request(request.url,{method:request.method,headers:h,body:JSON.stringify(next)})}
