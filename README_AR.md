# الماهر الماسي — AL-MAHER NEXT 1.2.0
...
## إضافات 1.2 الشاملة
- موديول الفروع وبيانات الشركة وأرقام التواصل.
- الشعار الأصلي في تسجيل الدخول والهيدر والتذكرة وشاشة التحميل.
- QR Camera fallback على Safari/iPhone عبر qr-scanner.
- الموردون والوكلاء.
- المهام والموافقات.
- تحسينات Desktop-First وانتقالات وحالات Hover.
